...
class GFUserInfoHeaderVC: UIViewController {
    ...
    lazy var bioLabel = GFBodyLabel(textAlignment: .justified)
    ...
    func layoutUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            nameLabel.centerYAnchor.constraint(equalTo: avatarImageView.centerYAnchor, constant: 8), // see this with 0
